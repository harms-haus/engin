...
/**
 * Build a set of {@link StatusCallbacks} that print formatted lines to stdout.
 *
 * @deprecated Superseded by {@link createStdoutRenderer} (src/cli/stdout-renderer.ts)
 * for the non-TTY path. This factory is retained during the transition because
 * commands.ts still imports it; new code should use the store-subscription
 * renderer instead.
 */
