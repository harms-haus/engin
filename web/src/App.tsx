...
export function App() {
  ...
  const runState: WorkflowRunState | undefined = state.runStates.get(selectedWorkflow.id) ?? {
      ...
      <div className="app-body">
        ...
        <main className="app-main">
          {Renderer && runState ? (
            ...
            <div className="app-main-placeholder">Workflow selected, but no renderer available</div>
          )}
        </main>
      </div>
    </div>
